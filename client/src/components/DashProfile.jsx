...
const handleChange = (e) => {
    ...
    //here id could be the username, email or password 
  };
  ...
  const handleSubmit = async (e) => {
    ...
    // below we are checking wether the form contains some data
    if(Object.keys(formData).length === 0) {
      setUpdateUserError('No changes made'); 
      return ; 
    }
    if(imageFileUploading) {
      setUpdateUserError('Please wait for image to upload'); s
      return; 
    }
     try {
