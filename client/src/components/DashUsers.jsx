     ...
     const fetchUsers = async() => {
      try {
          const res = await fetch(`/api/user/getusers`)
            // because this is a get request, we don't want to add any method or something else
...
//      setShowModal(false); 
//      try {
//         const res = await fetch(`/api/usser/deleteuser/${userIdToDelete}/${currentUser._id}`,
//         {
//           method:'DELETE',
//         }
//       ); 
